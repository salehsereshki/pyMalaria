...
import genome_area_dist_plot as GADP
import exon_boundry_plot as EBP
import gc_content as GCC
...
root = '/Users/saleh/PycharmProjects/malaria/'
PC_config = {
    'seq_address': root + 'PlasmoDB-48_PcynomolgiB_Genome.fasta',
    'meth_address': root + 'PC_merged.CX_report.txt',
    'annot_address': root + 'PlasmoDB-50_PcynomolgiB.gff',
...
PV_config = {
    'seq_address': root + 'PlasmoDB-48_PvivaxP01_Genome.fasta',
    'meth_address': root + 'PV_excluded23.CX_report.txt',
    'annot_address': root + 'PlasmoDB-48_PvivaxP01.gff',
...
PF_config = {
    'seq_address': root + 'PlasmoDB-48_Pfalciparum3D7_Genome.fasta',
    'meth_address': root + 'PF.CX_report.txt',
    'annot_address': root + 'PlasmoDB-48_Pfalciparum3D7.gff',
